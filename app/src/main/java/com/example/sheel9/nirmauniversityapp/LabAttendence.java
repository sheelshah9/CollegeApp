...
public class LabAttendence extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.attendance_lab,container,false);
        ...
        AttendanceAdapter ca = new AttendanceAdapter(createList(listOfSubjects,v),"la");
    ...
    private List<AttendanceInfo> createList(ArrayList<String> listOfSubjects,View v) {
        ...
        for (int i=0;i<listOfSubjects.size();i++) {
            ...
            att_info.percentage=((float)(att_info.numberoflectures-att_info.Count(att_info.subjectCode,"la"))/att_info.numberoflectures)*100;
